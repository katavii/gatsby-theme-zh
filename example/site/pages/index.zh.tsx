...
import SEO from 'gatsby-theme-zh/site/components/Seo';
import { useTranslation } from 'react-i18next';
import Banner from 'gatsby-theme-zh/site/components/Banner';
import Companies from 'gatsby-theme-zh/site/components/Companies';
import Features from 'gatsby-theme-zh/site/components/Features';
import Cases from 'gatsby-theme-zh/site/components/Cases';
import BannerSVG from 'gatsby-theme-zh/site/components/BannerSVG';
...
const IndexPage: React.FC = () => {
  ...
  return (
    <>
      <SEO title='中台前端解决方案' lang={i18n.language} />
      <Banner
