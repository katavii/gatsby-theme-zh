...
import RemoteRemark from '../components/RemoteRemark';
...
export const getGithubSourceUrl = ({
  ...
  return `${docGitUrl}/-/edit/master/${prefix}/${relativePath}`;
};
...
export default function Template({
  ...
  const {
    siteMetadata: { docs = [], githubUrl, docGitUrl },
    pathPrefix,
  } = site;
